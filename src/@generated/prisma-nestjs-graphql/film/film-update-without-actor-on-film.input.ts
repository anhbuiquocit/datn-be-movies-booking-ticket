...
import { CategoryUpdateOneWithoutFilmInput } from '../category/category-update-one-without-film.input';

@InputType()
export class FilmUpdateWithoutActorOnFilmInput {
    ...
    @Field(() => CategoryUpdateOneWithoutFilmInput, {nullable:true})
